  ...
  return (
    <div>
      ...
      <div style={wrapperStyles.buttonContainer}>
        <Button size="small" variant="contained" color="secondary" onClick={() => setDump('FIRST BUTTON')}>
          First{' '}
        </Button>
        <Button size="small" variant="contained" color="secondary" onClick={() => setDump('SECOND BUTTON')}>
          Second{' '}
        </Button>
      </div>
      <MarkersExample />
