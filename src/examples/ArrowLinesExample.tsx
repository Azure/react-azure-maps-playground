...
const ArrowLineExample: React.FC = () => {
  return (
    <div style={wrapperStyles.map}>
      ...
      <Description>
        This sample shows how to add arrow icons along a line on the map. When
        using a symbol layer, set the "placement" option to "line", this will
        render the symbols along the line and rotate the icons (0 degrees =
        right).
      </Description>
      <div style={wrapperStyles.map}>
        <AzureMapsProvider>
