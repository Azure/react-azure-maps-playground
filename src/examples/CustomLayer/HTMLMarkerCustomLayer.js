 ...
 */
import atlas, {source, data, Shape, ClusteredProperties, LayerOptions, HtmlMarker, layer, Map, BubbleLayerOptions} from "azure-maps-spatial-io";

export class HtmlMarkerLayerJS extends atlas.layer.BubbleLayer {
    /*********************
     * Constructor
     *********************/
    /**
